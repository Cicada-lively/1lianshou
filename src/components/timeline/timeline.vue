  ...
  <div class="timeline--box">
    <ul class="timeline">
      <li>
        ...
        <div class="content">
          <pre>-将工具YUICompressor替换为Microsoft Ajax Minifier（需要指定-evals:immediate）。</pre>
        </div>
        </li>
    </ul>
  </div>
...
ul.timeline
  ...
  background: url("../res/img/version_line.png") repeat-y scroll 120px 0 transparent
  margin: 50px 0
  padding: 0
...
ul.timeline li .number 
  position: absolute
  background: url("../res/img/version_dot.png") no-repeat scroll 0 0 transparent
  width: 56px
  height: 56px
  left: 97px
  line-height: 56px
